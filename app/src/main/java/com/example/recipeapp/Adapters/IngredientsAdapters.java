...
public class IngredientsAdapters extends  RecyclerView.Adapter<IngredientsViewHolder>{
    Context context;
    List<ExtendedIngredient> list;

    public IngredientsAdapters(Context context, List<ExtendedIngredient> list) {
    ...
    public void onBindViewHolder(@NonNull IngredientsViewHolder holder, int position) {
        ...
        Picasso.get().load("https://spoonacular.com/food-api/docs#Get-Recipe-Information:~:text=image%22%3A%20%22-,butter%2Dsliced.jpg,-%22%2C%0A%20%20%20%20%20%20%20%20%20%20%20%20%22measures"+list.get(position).image).into(holder.imageView_ingredients);
